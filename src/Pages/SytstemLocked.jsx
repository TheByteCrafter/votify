...
const SystemLocked = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden">
      {/* Kenyan Flag Background Pattern */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/5 via-transparent to-green-600/5"></div>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border-t-8 border-b-8 border-red-600 overflow-hidden">
          ...
          <div className="p-10 text-center">
            ...
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-red-50 to-green-50 border-l-4 border-yellow-400 p-4 rounded-r-lg mb-6">
            ...
            {/* Contact Information with Kenyan Theme */}
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-black/5 to-red-600/5 p-4 rounded-xl border border-red-100">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="flex flex-col md:flex-row items-center justify-between text-xs text-gray-500">
                <div className="flex items-center gap-2 mb-2 md:mb-0">
                  <div className="w-4 h-4 bg-gradient-to-r from-black via-red-600 to-green-600 rounded-sm"></div>
